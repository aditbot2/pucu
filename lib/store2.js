// Source https://github.com/amiruldev20
const { readFileSync, writeFileSync, existsSync, promises } = require('fs')
const { join } = require('path')

/** @type {typeof import('@whiskeysockets/baileys')} */ // @ts-ignore
const { default: initAuthCreds, BufferJSON, proto, isJidBroadcast, isJidGroup, WAMessageStubType, updateMessageWithReceipt, updateMessageWithReaction, /* @ts-ignore */ useMultiFileAuthState: baileysMultiFileAuthState } = require('@whiskeysockets/baileys')
...
module.exports = { makeInMemoryStore, useMultiFileAuthState, useMemoryAuthState, /* bind, */ fixFileName, JSONreplacer, KEY_MAP }